...
#ifndef USER_TASK_DEPENDS_XPP_OPT_INCLUDE_XPP_OPT_I_OBSERVER_H_
#define USER_TASK_DEPENDS_XPP_OPT_INCLUDE_XPP_OPT_I_OBSERVER_H_
...
#endif /* USER_TASK_DEPENDS_XPP_OPT_INCLUDE_XPP_OPT_I_OBSERVER_H_ */
