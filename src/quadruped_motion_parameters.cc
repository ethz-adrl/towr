...
//  };
  ...
  {
      II_,
      BP_, Pb_, BP_, Pb_, // left hind leg stationary
      BP_, Pb_, BP_, Pb_, // left hind leg stationary
      BP_, Pb_, BP_, Pb_, // left hind leg stationary
      II_
  };
                                               ...
                                               double p_overlap_opposite)
{
  ...
  ContactTimings  timings_ = { ts,  tl,  ts,  to,  ts,  tl,  ts,  to};
  ...
  for (int i=0; i<5; ++i) {
    ...
    contact_timings_.insert(contact_timings_.end(), timings_.begin(), timings_.end());
  }
