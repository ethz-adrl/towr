...
protected:
  ...
  static Spliner::Point1d start;
  static Spliner::Point1d end;
  static double T;
};

Spliner::Point1d SplineTest::start = Point();
Spliner::Point1d SplineTest::end = Point();
